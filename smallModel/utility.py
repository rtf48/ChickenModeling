...
path1 = 'smallModel/outputs/updated_dataset-feb-12_metrics.csv'
path2 = 'smallModel/outputs/polynomial_transform_metrics.csv'
compare_csv(path1, path2, 'poly_trans_comparison')